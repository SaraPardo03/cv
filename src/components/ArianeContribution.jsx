function ArianeContribution(){
  return <>
    <section id="ariane-contribution-section" className="h-[100vh]">
      <div className="bg-accent pt-[120px] px-[25px] color-text-light">
        <h3 className="subtitle">Contributions <span>Bienvenues!</span></h3>
        <h2 className="title pb-[20px]">Rejoignez l'aventure Ariane !</h2>
      </div>
      <div className="clip h-[20px]"></div>
      ...
      <div className="clip secondary h-[20px]"></div>
      <div className="bg-secondary">
        ...
        <div className="clip  odd h-[20px]"></div>
        <div className="bg-accent color-text-light py-[40px] px-[25px]">
          <h3 className="subtitle">Comment nous aider ?</h3>
          <div className="flex flex-row justyfy-center gap-[100px] py-[20px]">
            <button className="flex-1 clip">
            ...
            <button className="flex-1 clip primary">
...
export default ArianeContribution